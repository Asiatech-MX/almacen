...
\restrict bfUfBm01oj0fl4tOXW3uEdd7TUgDpbhhVGUQhDjWBEjWqduozpwQrixnM5BO0qX
...
--
-- Name: actualizar_ruta_categoria(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.actualizar_ruta_categoria() OWNER TO postgres;
...
--
-- Name: auditoria_materia_prima(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.auditoria_materia_prima() OWNER TO postgres;

--
-- Name: mapear_texto_a_categoria_id(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.mapear_texto_a_categoria_id(texto text) OWNER TO postgres;

--
-- Name: mapear_texto_a_presentacion_id(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.mapear_texto_a_presentacion_id(texto text) OWNER TO postgres;
...
CREATE TABLE public.auditoria (
    ...
    user_agent text,
    CONSTRAINT auditoria_tipo_operacion_check CHECK (((tipo_operacion)::text = ANY (ARRAY[('INSERT'::character varying)::text, ('UPDATE'::character varying)::text, ('DELETE'::character varying)::text])))
);
...
--
-- Name: COLUMN categoria.ruta_completa; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN categoria.id_institucion; Type: COMMENT; Schema: public; Owner: postgres
--
...
CREATE TABLE public.entrada_material (
    ...
    CONSTRAINT entrada_material_tipo_moneda_check CHECK (((tipo_moneda)::text = ANY (ARRAY[('MXN'::character varying)::text, ('USD'::character varying)::text, ('EUR'::character varying)::text])))
);
...
--
-- Name: materia_prima_legacy_20251114; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.materia_prima_legacy_20251114 (
    ...
    categoria character varying(100),
    proveedor_id uuid,
    CONSTRAINT materia_prima_estatus_check CHECK (((estatus)::text = ANY (ARRAY[('ACTIVO'::character varying)::text, ('INACTIVO'::character varying)::text, ('SUSPENDIDO'::character varying)::text]))),
...
ALTER TABLE public.materia_prima_legacy_20251114 OWNER TO postgres;
...
CREATE TABLE public.parametro_sistema (
    ...
    CONSTRAINT parametro_sistema_tipo_dato_check CHECK (((tipo_dato)::text = ANY (ARRAY[('STRING'::character varying)::text, ('NUMBER'::character varying)::text, ('BOOLEAN'::character varying)::text, ('DATE'::character varying)::text])))
);
...
--
-- Name: TABLE presentacion; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN presentacion.abreviatura; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN presentacion.factor_conversion; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN presentacion.id_institucion; Type: COMMENT; Schema: public; Owner: postgres
--
...
CREATE TABLE public.producto (
    ...
    CONSTRAINT producto_estatus_check CHECK (((estatus)::text = ANY (ARRAY[('ACTIVO'::character varying)::text, ('INACTIVO'::character varying)::text]))),
...
CREATE TABLE public.proveedor (
    ...
    fecha_registro timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    id_institucion integer NOT NULL,
    CONSTRAINT proveedor_estatus_check CHECK (((estatus)::text = ANY (ARRAY[('ACTIVO'::character varying)::text, ('INACTIVO'::character varying)::text])))
);
...
CREATE TABLE public.solicitud_compra (
    ...
    CONSTRAINT solicitud_compra_estatus_check CHECK (((estatus)::text = ANY (ARRAY[('PENDIENTE'::character varying)::text, ('APROBADO'::character varying)::text, ('RECHAZADO'::character varying)::text, ('COMPRADO'::character varying)::text, ('RECIBIDO'::character varying)::text])))
);
...
CREATE TABLE public.usuario (
    ...
    CONSTRAINT usuario_estatus_check CHECK (((estatus)::text = ANY (ARRAY[('ACTIVO'::character varying)::text, ('INACTIVO'::character varying)::text]))),
    CONSTRAINT usuario_tipo_usuario_check CHECK (((tipo_usuario)::text = ANY (ARRAY[('ADMIN'::character varying)::text, ('PROFESOR'::character varying)::text, ('CONSULTA'::character varying)::text])))
);
...
--
-- Name: materia_prima_legacy_20251114 id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
14	Herrería	\N	\N	1	Herrería	\N	\N	0	t	f	2025-11-28 18:13:36.861	2025-12-02 22:31:08.392	1
3	Fontanería	Materiales de plomería	\N	1	Fontanería	\N	\N	0	t	f	2025-11-28 19:09:24.016604	2025-12-03 11:18:59.86	1
13	Otros	Otros productos no clasificados	\N	1	Otros	\N	\N	0	t	f	2025-11-28 19:09:24.016604	2025-12-03 12:17:35.998	1
\.
...
a3d0f7bc-f45f-44a1-a54f-bb0cdba83163	7009937536944	TEST DEBUG	\N	\N	Unidad	1.00	1.00	\N	\N	\N	\N	\N	\N	f	2025-11-29 00:09:38.442+00	2025-12-10 03:57:13.849624+00	\N	1	13
\.
...
4f799916-47f6-4588-abf3-e453855fd30b	a3d0f7bc-f45f-44a1-a54f-bb0cdba83163	STATUS_UPDATE	{"stock_actual": 1, "activo_anterior": true, "estatus_anterior": "ACTIVO"}	{"motivo": "Cambio de estatus: ACTIVO → INACTIVO", "usuario_id": null, "activo_nuevo": false, "estatus_nuevo": "INACTIVO"}	\N	2025-12-10 03:57:13.279+00	-1
\.


--
-- Data for Name: materia_prima_legacy_20251114; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
16	Docena	\N	\N	Unidad	12.0000	t	f	2025-12-01 17:29:55.2	2025-12-03 11:21:27.023	1
5	Bolsa	Contenedor tipo bolsa	\N	\N	\N	t	f	2025-11-28 19:09:24.016604	2025-12-03 12:03:06.842	1
17	Pieza	\N	\N	\N	\N	t	f	2025-12-01 17:33:38.607	2025-12-09 21:37:45.043	1
\.
...
SELECT pg_catalog.setval('public.presentacion_id_seq', 18, true);
...
--
-- Name: categoria categoria_unique_institution; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: CONSTRAINT categoria_unique_institution ON categoria; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: materia_prima_legacy_20251114 materia_prima_codigo_barras_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: materia_prima materia_prima_migration_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: materia_prima_legacy_20251114 materia_prima_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: presentacion presentacion_unique_institution; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: CONSTRAINT presentacion_unique_institution ON presentacion; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: materia_prima unique_codigo_barras_active; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_categorias_activas; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_categorias_activas_institution; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_categorias_institution; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_categorias_jerarquia; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_materia_prima_auditoria_accion_fecha; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_materia_prima_auditoria_fecha; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_materia_prima_auditoria_materia_prima_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_materia_prima_auditoria_materia_prima_legacy_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_materia_prima_busqueda_texto; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_materia_prima_categoria; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_materia_prima_fecha_caducidad; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_materia_prima_proveedor; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_materia_prima_stock_bajo; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_presentaciones_activas; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_presentaciones_activas_institution; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_presentaciones_institution; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: categoria trg_actualizar_ruta_categoria; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: materia_prima_legacy_20251114 trigger_auditoria_materia_prima; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: materia_prima trigger_materia_prima_actualizado_en; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: materia_prima_legacy_20251114 trigger_materia_prima_actualizado_en; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: categoria categoria_id_institucion_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: materia_prima materia_prima_categoria_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: materia_prima_legacy_20251114 materia_prima_id_institucion_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: materia_prima materia_prima_presentacion_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: presentacion presentacion_id_institucion_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict bfUfBm01oj0fl4tOXW3uEdd7TUgDpbhhVGUQhDjWBEjWqduozpwQrixnM5BO0qX
