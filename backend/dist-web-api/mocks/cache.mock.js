...
exports.redisConfig = exports.adminCacheMiddleware = exports.userCacheMiddleware = exports.apiCacheMiddleware = exports.cacheInvalidator = exports.cacheMiddleware = exports.createMockCacheService = exports.getCacheService = exports.MockCacheService = void 0;
class MockCacheService {
    ...
    async setWithPattern(pattern, value, options) {
        this.stats.totalOperations++;
...
let mockCacheServiceInstance = null;
...
const cacheMiddleware = (options = {}) => {
    return async (req, res, next) => {
        ...
        const cacheService = (0, exports.getCacheService)();
...
const cacheInvalidator = (pattern) => {
    return async (req, res, next) => {
        const cacheService = (0, exports.getCacheService)();
...
exports.apiCacheMiddleware = (0, exports.cacheMiddleware)({ ttl: 300 }); // 5 minutes default
exports.userCacheMiddleware = (0, exports.cacheMiddleware)({ ttl: 600 }); // 10 minutes default
exports.adminCacheMiddleware = (0, exports.cacheMiddleware)({ ttl: 1800 }); // 30 minutes default
